                                        ...
                                        <div className='ml-4'>
                                            {item?.card?.info?.imageId ? (
                                                <div className='relative'>
                                                    ...
                                                    />
                                                    <button onClick={() => dispatch(addToCart(item))} className='absolute bottom-2 cursor-pointer left-1/2 transform -translate-x-1/2 bg-orange-500 hover:bg-orange-600 text-white px-1 py-1 rounded-md text-sm font-medium transition-colors duration-200'>
                                                        Add +
                                                    </button>
                                                </div>
                                            ) : (
                                                <button onClick={() => dispatch(addToCart(item))} className='bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200'>
                                                    Add +
                                                </button>
                                            )}
                                        </div>
